...
{
    /// <summary>
    /// This class represents a superclass for packets dedicated to identifying objects in order to relay serialization
    /// to the object itself.
    /// As such, it's primarily used to update data for specific objects.
    /// </summary>
    /// <typeparam name="T">The type of object, which extends BinarySerializable</typeparam>
    public abstract class ObjectData<T> : LWMPacket where T : BinarySerializable
    {
