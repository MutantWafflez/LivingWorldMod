...
namespace LivingWorldMod.Custom.Classes.Packets {
    ...
    public abstract class LWMPacket {
        ...
        /// <summary>
        /// Write packet data to a writer, usually going to be a ModPacket. This is intended to be
        /// called in Send, so it is protected to prevent confusion about which method to use.
        /// </summary>
        /// <param name="writer"> The binary writer </param>
        protected abstract void Write(BinaryWriter writer);

        /// <summary>
        /// Reads the data written in Write into the fields of this object. Both this and Handle are
        /// expected to be called from LWMPacket.TryHandlePackets, so this is protected to avoid confusion.
        /// </summary>
