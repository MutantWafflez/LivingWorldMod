            ...
            while (continueRoomTunnelGen) {
                ...
                if (roomTunnelDisplacement <= 0) {
                    if (doRoomGen) {
                        ...
                        WorldGen.PlaceObject(edgeCheck > roomY ? roomEdge1 + 6 : roomEdge2 - 7, entranceY + tunnelSize - 2, ModContent.TileType<CryptDoorTile>(), style: 0, direction: 1);
                        WorldGen.PlaceObject(edgeCheck > roomY ? roomEdge2 - 7 : roomEdge1 + 6, entranceY + tunnelSize - 2, ModContent.TileType<CryptDoorTile>(), style: 1, direction: 1);
