...
namespace LivingWorldMod.Content.Projectiles {
    /// <summary>
    /// Base class for all LWM Projectiles that currently only has the functionality of overriding the
    /// Texture value to retrieve the projectile's sprite from the Assets folder.
    /// </summary>
