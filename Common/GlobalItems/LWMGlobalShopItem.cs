...
namespace LivingWorldMod.Common.GlobalItems {
    ...
    public class LWMGlobalShopItem : GlobalItem {
        ...
        /// <summary>
        /// Used to differentiate shop slots that were there upon opening the UI, and those that
        /// were created by selling items to an NPC. Set to true when setting up shop.
        /// </summary>
        public bool isOriginalShopSlot;

        /// <summary>
        /// This is the ShopItem instance stored in the dailyShop array of a Villager. Keeping a
        /// reference to it means that in the buy/sell ModPlayer hooks, we can decrement the stack
        /// size stored in the Villager's shop array, so that next time the shop is opened, the
        /// remaining stock persists.
        /// </summary>
