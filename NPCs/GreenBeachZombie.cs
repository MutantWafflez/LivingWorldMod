...
namespace LivingWorldMod.NPCs
{
	...
	public class GreenBeachZombie : ModNPC
	{
		...
		public override float SpawnChance(NPCSpawnInfo spawnInfo) {
			...
			return SpawnCondition.OverworldNightMonster.Chance * 2;
			}
			return 0;
		}
		...
		public override void HitEffect(int hitDirection, double damage) {
			...
			if (npc.life <= 0) {
				Gore.NewGore(npc.position, npc.velocity, mod.GetGoreSlot("Gores/GreenHead"), npc.scale);
