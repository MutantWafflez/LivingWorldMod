...
/// </summary>
public readonly struct DynamicLocalizedText(LocalizedText text, object substitutionObject = null, LocalizedText fallbackText = null) {
    ...
    public string SubstitutedText   {
        get {
            ...
            return substitutionObject is not null ? text.FormatWith(substitutionObject) : text.Value;
        }
    }
