...
namespace LivingWorldMod
{
    public class LivingWorldMod : Mod
    {
        ...
        internal static List<VillagerQuest>[] possibleQuests = new List<VillagerQuest>[(int)VillagerID.VillagerTypeCount];

        //The upper cap of the reputation value
        ...
        public void InitializeDefaultGiftPreferences()
        {
            ...
            SetGiftValue((int)VillagerID.Harpy, ItemID.Feather, -3);
        ...
        public void InitializeDefaultVillagerQuests()
        {
            ...
            possibleQuests[(int)VillagerID.Harpy].Add(new HarpyQuest(
